...
const SECTIONS: { id: string; title: string; body: ReactNode }[] = [
  ...
  },
  {
    ...
    body: (
      <p>
        After 7 days, fees for the current billing cycle are non-refundable, except where a refund
        is required by law, or in the event of a prolonged service outage attributable to TryBild
        (as per the SLA in our Terms of Service).
      </p>
    ),
  },
  {
